...
export default {
    ...
    screen: {
        ...
        searchField: {
            ...
            borderWidth: 1,
            borderRadius: 21,
            borderColor: Colors.colors.white_three
        } as ViewStyle,
        backButtonStyle: {
    ...
    texts: {
        ...
        // Medium
        giantMediumText: {
            fontFamily: Fonts.defaultMediumFont,
           // fontSize: RF(3.5) < 24 && RF(3.5) > 20 ? RF(3.5) : 24,
            color: Colors.colors.black,
            textAlignVertical: 'center'
        } as TextStyle,
